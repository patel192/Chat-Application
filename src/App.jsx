...
import NotificationCenter from "./Components/ChatBox.jsx/NotificationCenter";
import BlockedUsers from "./Components/ChatBox.jsx/BlockedUsers";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/blockedusers" element={<BlockedUsers />}></Route>
      </Routes>
    </>
  );
}
